...
_recipes_pil_prescript(['ImImagePlugin', 'WmfImagePlugin', 'XVThumbImagePlugin', 'XbmImagePlugin', 'TgaImagePlugin', 'SpiderImagePlugin', 'FliImagePlugin', 'MspImagePlugin', 'XpmImagePlugin', 'FpxImagePlugin', 'PcxImagePlugin', 'DdsImagePlugin', 'TiffImagePlugin', 'IptcImagePlugin', 'WebPImagePlugin', 'PsdImagePlugin', 'GbrImagePlugin', 'SgiImagePlugin', 'PngImagePlugin', 'PdfImagePlugin', 'DcxImagePlugin', 'CurImagePlugin', 'IcoImagePlugin', 'PpmImagePlugin', 'PalmImagePlugin', 'MicImagePlugin', 'BufrStubImagePlugin', 'ImtImagePlugin', 'GifImagePlugin', 'BlpImagePlugin', 'MpoImagePlugin', 'BmpImagePlugin', 'FitsStubImagePlugin', 'GribStubImagePlugin', 'PixarImagePlugin', 'McIdasImagePlugin', 'EpsImagePlugin', 'SunImagePlugin', 'Hdf5StubImagePlugin', 'MpegImagePlugin', 'PcdImagePlugin', 'FtexImagePlugin', 'JpegImagePlugin', 'FitsImagePlugin', 'IcnsImagePlugin', 'Jpeg2KImagePlugin'])
...
DEFAULT_SCRIPT='SplitScreener.py'
SCRIPT_MAP={}
_run()
